...
- (void) initializeFromDefaults {
	...
	[textToSpeech setState:[[NSUserDefaults standardUserDefaults] boolForKey:@"allTextToSpeech"]];
	if ([[[NSUserDefaults standardUserDefaults] stringForKey:@"speechOnlyInRoom"] length]) {
		[speechOnlyInRoomField setStringValue:[[NSUserDefaults standardUserDefaults] stringForKey:@"speechOnlyInRoom"]];
	}
}
...
- (void) enableTextToSpeech:(id) sender {
	[[NSUserDefaults standardUserDefaults] setObject:[NSNumber numberWithBool:(BOOL)[sender state]] forKey:@"allTextToSpeech"];
}

- (void) setSpeechOnlyInRoom:(id) sender {
	[[NSUserDefaults standardUserDefaults] setObject:[speechOnlyInRoomField stringValue] forKey:@"speechOnlyInRoom"];
}
